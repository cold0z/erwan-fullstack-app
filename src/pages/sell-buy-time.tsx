...
const BestTimeToBuySellPage = ({ googleData, amazonData }: Props) => {
  ...
  const data = [
    {
      name: "Google",
      buyDate: googleResults.buyDate.toString(),
      sellDate: googleResults.sellDate.toString(),
    ...
    {
      name: "Amazon",
      buyDate: amazonResults.buyDate.toString(),
      sellDate: amazonResults.sellDate.toString(),
  ...
  return (
    <div className="m-6">
      <h1 className="text-lg text-green-600 mb-10 content-centre">
        Le meilleur moment pour acheter et vendre des actions
      </h1>
